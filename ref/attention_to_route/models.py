...
class TSPDecoder(nn.Module):
    ...
    def forward(self, x, C=10, rollout=False):
        ...
        for i in range(n_node):
            ...
            ## constraints mask
            ## 根据visit_idx对应的坐标，计算与其他点的角度关系，将30-330度之间的点mask掉。
...
class TSPAgent(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_set = TSPTrainSet(self.hparams.n_batch_per_epoch,self.hparams.batch_size, self.hparams.n_node)
