...
def generate_op_data(dataset_size, op_size, prize_type='const'):
    ...
    # Max length is approximately half of optimal TSP tour,
    # such that half (a bit more) of the nodes can be visited
    # which is maximally difficult as this has the largest number of
    # possibilities
